...
public class ContactCreateFrame extends JFrame {
	...
	private ContactMain app; // notifyContactCreated 메서드를 갖고 있는 객체
	...
	public static void showFrame(Component parent, ContactMain app) {
	...
	private ContactCreateFrame(Component parent, ContactMain app) {
		this.parent = parent;
		this.app = app;
