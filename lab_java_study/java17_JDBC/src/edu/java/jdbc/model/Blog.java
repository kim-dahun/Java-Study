...
public class Blog {
	...
	public String toString() {
		...
		return String.format("Blog(id=%d, title=%s, content=%s, author=%s, createdTime=%s, modifiedTime=%s)", this.id,
				this.title, this.content, this.author, this.createdTime, this.modifiedTime);
	}
