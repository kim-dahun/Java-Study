...
public class ListMain01 {
	...
	public static void main(String[] args) {
		...
		System.out.println(languages ); // toString 메서드 오버라이딩 되어 있음.
		...
		System.out.println(languages.get(0)); // 인덱스는 0부터 시작. 마지막 인덱스는 (size-1)
		...
		while(itr.hasNext()) {
			System.out.println(itr.next()); // 인덱스 한 칸을 이동하면서 이동하기 전 자리에 있던 문자열을 리턴.
		}
