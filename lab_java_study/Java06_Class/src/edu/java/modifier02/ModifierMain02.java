...
// 2. 다른 패키지에 있는 클래스는
// (1) Import 선언문을 작성하고 변수 선언에서 사용
// import edu.java.modifier01.AccessTest;

// (2) Import 선언문 없이 
// 패키지 이름을 포함한 클래스 전체 이름(Full Name)을 변수 선언과 생성자 호출에서 사용
// edu.java.modifier01.AccessTest acc1 = new edu.java.modifier01.AccessTest(1, 2, 3, 4);
...
public class ModifierMain02 {
	...
	public static void main(String[] args) {
		...
		AccessTest test = new AccessTest(1,1,1,1);
		//Ctrl + Shift + O : import 선언문 최적화(optimize)
		// - 필요한 import문은 자동으로 작성, 필요없는 import 문은 자동으로 삭제.
